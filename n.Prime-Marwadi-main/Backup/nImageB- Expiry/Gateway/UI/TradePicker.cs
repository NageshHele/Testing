...
namespace Gateway
{
    public partial class TradePicker : XtraForm
    {
        /// <summary>
        ...
        private void btn_StartPick_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _DumpData = new DumpData(_MySQLCon, ip_GatewayHBServer, _GatewayHBServerPORT, _logger, ds_Config, _SpanFolderPath);

                //added on 25JAN2021 by Amey
                ind_TradeFileCMAvailable.ToolTip = _DumpData._TradeFileCM;
                ind_TradeFileCM.ToolTip = _DumpData._TradeFileCM;
                ind_TradeFileFOAvailable.ToolTip = _DumpData._TradeFileFO;
                ind_TradeFileFO.ToolTip = _DumpData._TradeFileFO;

                //added on 20APR2021 by Amey
                ind_TradeFileBSECMAvailable.ToolTip = _DumpData._TradeFileBSECM;
                ind_TradeFileBSECM.ToolTip = _DumpData._TradeFileBSECM;
        ...
        private void _DumpData_eve_TradeFileStatus(bool isFOAvailable, bool isCMAvailable, bool isBSECMAvailable)
        {
            try
            {
