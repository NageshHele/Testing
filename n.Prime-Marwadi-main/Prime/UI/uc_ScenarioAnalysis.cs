        ...
        private void ComputeScenarioVaR(ref DataTable dt_ScenarioAnalysis, ref DataTable dt_ChildUnderlying, ref DataTable dt_ChildPosition)
        {
            try
            {
                ...
                if (list_AllScenarios.Count > 0)
                {
                    ...
                    foreach (var _Client in dict_AllPositions.Keys)
                    {
                        //var CLevelVaR = 0.0;
                        double CLevelFuturesMTM = 0, CLevelOptionsMTM = 0, CLevelEquityMTM = 0;
                        double CLevelIntradayFuturesMTM = 0, CLevelIntradayOptionsMTM = 0, CLevelIntradayEquityMTM = 0;
                        var CLevelDelta = 0.0;
                        var CLevelGamma = 0.0;
                        var CLevelTheta = 0.0;
                        var CLevelVega = 0.0;
                        ...
                        // Added by Snehadri on 22JUL2021 for Client Underlying Details
                        Dictionary<string, List<ConsolidatedPositionInfo>> dict_UnderlyingInfo = dict_AllPositions[_Client].GroupBy(row => row.Underlying).ToDictionary(kvp => kvp.Key, kvp => kvp.ToList());
                                                

                        // Added by Snehadri on 22JUL2021 for Client Underlying Details
                        foreach (var _Underlying in dict_UnderlyingInfo.Keys)
                        {
                            double UnderlyingFuturesMTM = 0, UnderlyingOptionsMTM = 0, UnderlyingEquityMTM = 0;
                            double UnderlyingIntradayFuturesMTM = 0, UnderlyingIntradayOptionsMTM = 0, UnderlyingIntradayEquityMTM = 0;
