    ...
    internal class nCompute
    {
        ...
        private void ComputeAndUpdatePortfolio(List<ConsolidatedPositionInfo> list_ReceivedPositions)
        {
            try
            {
                ...
                double CLevelVaR = 0, CLevelVaRAbs = 0, CurrIV = 0, _PayInPayOut = 0, _DayNetPremium = 0, CLevelDelMargin = 0;
                ...
                if (CollectionHelper.IsFullVAR)
                {
                    foreach (var Underlying in dict_MaxLossUnderlyingWise.Keys)
                    {
                        ...
                        if (isCPParentExpanded)
                        {
                            ...
                            var TotalMTM = _UnderlyingInfo.FuturesMTM + _UnderlyingInfo.OptionsMTM + _UnderlyingInfo.EquityMTM;
                            ...
                            CollectionHelper.gc_CP.Invoke((MethodInvoker)(() =>
                            {
                                ...
                                _CPUnderlying.FuturesMTM = _UnderlyingInfo.FuturesMTM;
                                _CPUnderlying.OptionsMTM = _UnderlyingInfo.OptionsMTM;
                                _CPUnderlying.EquityMTM = _UnderlyingInfo.EquityMTM;

                                _CPUnderlying.MTM = TotalMTM;

                                //added on 28MAY2021 by Amey
                                _CPUnderlying.IntradayFuturesMTM = _UnderlyingInfo.IntradayFuturesMTM;
                                _CPUnderlying.IntradayOptionsMTM = _UnderlyingInfo.IntradayOptionsMTM;
                                _CPUnderlying.IntradayEquityMTM = _UnderlyingInfo.IntradayEquityMTM;

                                //added on 15APR2021 by Amey
                                _CPUnderlying.IntradayMTM = _UnderlyingInfo.IntradayFuturesMTM + _UnderlyingInfo.IntradayOptionsMTM + _UnderlyingInfo.IntradayEquityMTM;
                ...
                if (UpdateCPParent)
                {
                    ...
                    {
                        var MTMLimit = limitInfo.MTMLimit;
                        var VARLimit = limitInfo.VARLimit;
                        var MarginLimit = limitInfo.MarginLimit;
                        var bankniftyExpoLimit = limitInfo.BankniftyExpoLimit;
                        var niftyExpoLimit = limitInfo.NiftyExpoLimit;

                        _CPParent.MTMLimit = MTMLimit;
                        _CPParent.VARLimit = VARLimit;
                        _CPParent.MarginLimit = MarginLimit;
                        _CPParent.BankniftyExpoLimit = bankniftyExpoLimit;
                        _CPParent.NiftyExpoLimit = niftyExpoLimit;
        ...
        private void ComputeAndUpdateUnderlyingView(List<ConsolidatedPositionInfo> list_ReceivedPositions)
        {
            try
            {
                ...
                if (UpdateUCParent)
                {
                    _UCParent.FuturesMTM = _ULevelInfo.FuturesMTM;
                    _UCParent.OptionsMTM = _ULevelInfo.OptionsMTM;
                    _UCParent.EquityMTM = _ULevelInfo.EquityMTM;
                    _UCParent.MTM = _ULevelInfo.FuturesMTM + _ULevelInfo.OptionsMTM + _ULevelInfo.EquityMTM;

                    _UCParent.IntradayFuturesMTM = _ULevelInfo.IntradayFuturesMTM;
                    _UCParent.IntradayOptionsMTM = _ULevelInfo.IntradayOptionsMTM;
                    _UCParent.IntradayEquityMTM = _ULevelInfo.IntradayEquityMTM;
                    _UCParent.IntradayMTM = _ULevelInfo.IntradayFuturesMTM + _ULevelInfo.IntradayOptionsMTM + _ULevelInfo.IntradayEquityMTM;
