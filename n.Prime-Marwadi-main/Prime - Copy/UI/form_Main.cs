...
namespace Prime.UI
{
    public partial class form_Main : FluentDesignForm
    {
        ...
        private void _EngineHeartBeatClient_eve_HeartBeatTickReceived(string _ReceivedTick)
        {
            ...
            try
            {
                if (IsHandleCreated)
                {
                    ...
                    if (arr_fields.Length > 7)
                    {
                        Invoke((MethodInvoker)(() =>
                        {
                            lbl_NiftyVal.Text = arr_fields[6];
                            lbl_BankNiftyVal.Text = arr_fields[7];
                        }));
                    }                       
                }
            }
        ...
        private void _EngineDataClient_eve_SpanData(Dictionary<string, double[]> dict_ReceivedSpan)
        {
            ProcessSpanData(dict_ReceivedSpan);
        }
        ...
        private void ProcessSpanData(Dictionary<string, double[]> dict_ReceivedSpanData)
        {
            try
            {
