...
namespace Gateway.Core_Logic
{
    ...
    class CTradeProcess
    {
        ...
        //drop-copy-trade-127.fo.2022-02-03
        ...
        {
            if (Instance is null)
                Instance = new CTradeProcess(_logger, ds_Config, isDebug, dict_CustomScripInfo, dict_ScripInfo, dict_TokenScripInfo);
        }
                                ...
                                using (BufferedStream bs = new BufferedStream(fs))
                                {
                                    using (StreamReader sr = new StreamReader(bs))
                                    {
                                        ...
                                        while ((strData = sr.ReadLine()) != null)
                                        {
                                            ...
                                            if (arr_Fields.Length > 18 && arr_Fields[0] != "") //added on 2-1-18
                                            {
