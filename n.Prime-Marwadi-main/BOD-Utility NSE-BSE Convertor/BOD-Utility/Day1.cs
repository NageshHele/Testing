    ...
    internal static class Day1
    {
                ...
                foreach (var _Line in arr_Day1)
                {
                    ...
                    try
                    {
                        ...
                        if (MarkToClosing)
                        {
                            ...
                            catch (Exception ee) { _logger.Error(ee,Environment.NewLine + "Day1 Loop Closing : " + _Line ); }
                        }
                    ...
                    catch (Exception ee) { _logger.Error(ee, Environment.NewLine + "Day1 Loop : " + _Line); isAnyError = true; }
                }
            }
            catch (Exception ee)
            {
            ...
            ConcurrentDictionary<string, ContractMaster> dict_TokenScripInfo)
        {
            ...
            try
            {
                ...
                using (FileStream stream = File.Open(PS03.FullName, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
                {
                    using (StreamReader sr = new StreamReader(stream))
                    {
                        ...
                        while ((line1 = sr.ReadLine()) != null)
                        {
                            ...
                            if (fields[0].Trim() != "")
                            {
                                ...
                                {
                                    _logger.Error(ee, Environment.NewLine + "Data Incorrect PS03 : " + line1);
