                                            ...
                                            else
                                            {
                                                ...
                                                if (dtNearestExpiry < dtExpiry)  //Changed on 22JAN2021 For Nearest expirydate
                                                {
                                                    if (ScripInfo.Segment == en_Segment.NSECD)
                                                        ...
                                                        arr_ExpiryMargin = _SpanConnectorCD.GetMargin(1, ExpiryKey, "NSE", "EQFO", ScripInfo.Symbol, dtExpiry.ToString("yyyy-MM-dd").Replace("-", ""), "", "", "E", _PositionInfo.TradeQuantity.ToString());
